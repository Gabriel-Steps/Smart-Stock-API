...
{
    public class UpdateProductInputValidatorDto : AbstractValidator<UpdateProductInputDto>
    {
        public UpdateProductInputValidatorDto()
        {
            RuleFor(x => x.Name)
            ...
            RuleFor(x => x.LastRestockDate)
                .LessThanOrEqualTo(DateTime.Now)
                .WithMessage("Last restock date cannot be in the future.");
        }
    }
}
